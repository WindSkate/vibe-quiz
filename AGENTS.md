...
- [ ] Инициализировать Spring Boot проект (pom.xml)
...
- [ ] Flyway миграции
- [ ] Entity + Repository
- [ ] DTO + MapStruct мапперы
- [ ] REST контроллеры для тем
- [ ] REST контроллеры для вопросов
- [ ] Загрузка/удаление изображений

### Шаг 3: Лобби (REST + Redis)
- [ ] Создание лобби с генерацией кода
